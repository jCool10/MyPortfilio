$(document).ready(function () {
  ...
  $('.js-carousel-review').each(function () {
    var teammatesCarousel = new Swiper('.js-carousel-review', {
      slidesPerView: 6,
      spaceBetween: 30,
      speed: 300,
      grabCursor: true,
  ...
  // Web
  $('.js-carousel-web').each(function () {
    var webCarousel = new Swiper('.js-carousel-web', {
      slidesPerView: 5,
      spaceBetween: 30,
      //loop: true,
      grabCursor: true,
  ...
  $('.js-carousel-softskill').each(function () {
    var webCarousel = new Swiper('.js-carousel-softskill', {
      slidesPerView: 4,
      spaceBetween: 30,
      //loop: true,
      grabCursor: true,
